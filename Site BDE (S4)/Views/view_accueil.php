...
require_once("../Includes/header.php") ?>
       ...
       <div id="acceuil">
        ...
        <p>Le BDE est le bureau des étudiants. Il est composé d'étudiants motivés pour apporter de la bonne 
            humeur, du fun et de l'activté sur le campus. Ce club d'étudiants apporte un peux de bonheur et de joie
             dans la vie universitaire de leurs camarades, en organisant des soirées, des sorties et autres évenements de tout genre.</p>
        </div>
        <div class="horraire">
        <table>
            <thead>
